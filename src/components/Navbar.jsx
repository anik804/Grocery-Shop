            ...
            >
              ...
              {session?.user?.image ? (
                <img
                  ...
                  alt="avatar"
                  className="w-10 h-10 rounded-full border-2 border-green-900 shadow-md"
                />
              ) : (
                <FaUserCircle className="w-10 h-10 text-green-900" />
              )}
            </motion.div>
                ...
                >
                  <ul className="flex flex-col p-2">
                    <motion.li
                      ...
                      className="px-4 py-2 rounded-md cursor-pointer text-green-900"
                    >
