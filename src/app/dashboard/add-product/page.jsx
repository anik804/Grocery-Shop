      ...
      >
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <textarea
            ...
            onChange={handleChange}
            required
            className="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-emerald-500 focus:outline-none transition resize-none"
          />
          <input
            type="number"
            name="price"
          ...
          <input
            type="text"
            name="packaging"
            placeholder="Packaging (e.g., Tetra Pak)"
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full py-2 rounded-lg bg-emerald-600 text-white font-semibold hover:bg-emerald-700 transition shadow-md"
          >
