  ...
  return (
    <section className="min-h-screen flex flex-col justify-center items-center bg-gradient-to-b from-green-50 to-white px-4 py-12">
      ...
      <motion.h2
        ...
        className="text-4xl md:text-5xl font-bold text-green-700 text-center mb-8"
      >
        Contact Us
      </motion.h2>
      ...
      <div className="max-w-5xl w-full grid md:grid-cols-2 gap-8">
        <motion.div
          ...
          className="bg-green-600 text-white rounded-2xl shadow-lg p-8 flex flex-col justify-center"
        >
          ...
          <ul className="space-y-2">
            <li>
              <strong>Email:</strong> chakrabortyanik234@gmail.com
            </li>
            <li>
              <strong>Phone:</strong> +8801310763509
            </li>
            <li>
