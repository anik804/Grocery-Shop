...
export default function BlogsPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-green-50 to-green-100 py-10 px-6">
      {/* Page Header */}
      <motion.h1
        initial={{ opacity: 0, y: -40 }}
        animate={{ opacity: 1, y: 0 }}
        transition={{ duration: 0.6 }}
        className="text-3xl md:text-4xl font-bold text-green-900 text-center mb-10"
      >
        Our Latest Blogs
      </motion.h1>
              ...
              >
                ...
                <div className="p-5 flex flex-col flex-grow">
                  ...
                  <motion.button
                    ...
                    whileTap={{ scale: 0.95 }}
                    className="mt-4 px-4 py-2 bg-green-900 text-white rounded-lg hover:bg-green-800 transition"
